...
export async function fetchDatasetDates() {
  try {
    const [income, birth, coe, ges, climate] = await Promise.all([
    ...
    return { income: 'Data as of 2025', birth: 'Data as of 2025', hdb: 'Data as of Aug 2026', coe: 'Data as of Aug 2026', ges: 'Data as of 2024', climate: 'Data as of Jul 2026' };
  }
}
